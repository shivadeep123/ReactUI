    ...
    return(
      <div className="nav">
        <div className="nav__wrapper">
          <Link to="/" className="nav__logo-wrapper"><img className="nav__logo" src="https://lh3.googleusercontent.com/zf6-5u_6u8pDbUdfhyba00JLZUrqAVZ6gQ3VbkjwQAvrmjky64KMplR9PaYEW_0m_5Q=w300"/></Link>
          { navButtons }
        </div>
      </div>
    );
